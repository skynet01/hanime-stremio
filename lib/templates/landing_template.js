  ...
  <div class="frame">
    ...
    <main class="grid">
      ...
      <section class="identity">
        ...
        <div class="edition">EDITION&nbsp;&nbsp;${escapeHtml(version)}&nbsp;&nbsp;·&nbsp;&nbsp;PRIVATE&nbsp;PRESS</div>
    ...
    <footer class="footer">
      <span class="colophon">Set in Fraunces &amp; DM&nbsp;Sans &nbsp;·&nbsp; <em>Configured locally</em></span>
    ...
    (function () {
      ...
      function getManifestUrl() {
        ...
        if (Object.keys(cfg).length > 0) {
          ...
          return window.location.protocol + '//' + window.location.host + '/' + encoded + '/manifest.json';
        }
      ...
      function updateLinks() {
        ...
        if (installLink) {
          ...
          if (Object.keys(cfg).length > 0) {
            var encoded = encodeURIComponent(JSON.stringify(cfg));
            installLink.href = 'stremio://' + window.location.host + '/' + encoded + '/manifest.json';
          } else {
