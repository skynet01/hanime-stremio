...
const config = {
  ...
  api: {
    // hanime.tv stopped serving /api/v8/video (HTML 404 as of 2026-07);
    // the JSON API lives on the freeanimehentai.net mirrors now
    authority: 'cached.freeanimehentai.net',
    defaultAuthority: 'hw.hanime.tv',
    manifestAuthority: 'cached.freeanimehentai.net',
    searchUrl: 'https://cached.freeanimehentai.net/api/v10/search_hvs',
